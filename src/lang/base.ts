export default {
  ...
  translation: {
    settings: {
      ...
      'update-last-used-date': 'Update Usage and Streak Data',
    ...
    dashboard: {
      ...
      'add-tab': 'Add a Dashboard Tab...',
      options: 'Dashboard Options',
      'select-dashboard-to-move-widget': 'Move widget to which dashboard?',
      'empty-message':
        'Fill in the blanks with different charts, statistics, and other widgets to build your own personalized picture of your life.',
    ...
    setup: {
      'choose-time-format': 'Which format looks right?',
    ...
    board: {
      'edit-sort': 'Edit / Sort',
      'create-new-board': 'Add New Tab',
      'board-options': 'Tab Options',
      'add-existing-tracker': 'From Existing',
      'create-custom-tracker': 'Add New Tracker',
