...
type NeighborsType = {
  right: { even: string; odd?: string };
  top: { even: string; odd?: string };
  bottom: { even: string; odd?: string };
  left: { even: string; odd?: string };
};

const BASE32 = '0123456789bcdefghjkmnpqrstuvwxyz';
const NEIGHBORS: NeighborsType = {
